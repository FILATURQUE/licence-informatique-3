error id: file://<WORKSPACE>/Algo/TM3/Graph.java:java/util/ArrayList#contains().
file://<WORKSPACE>/Algo/TM3/Graph.java
empty definition using pc, found symbol in pc: java/util/ArrayList#contains().
...
public class Graph {
    ...
    public void ajoutArete(int i, int j) {
        if (j > sommets.size()-1) {
            ...
            if (!sommets.get(i).voisins.contain@@s(j)){

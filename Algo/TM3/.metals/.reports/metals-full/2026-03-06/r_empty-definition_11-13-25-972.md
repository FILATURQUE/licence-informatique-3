error id: file://<WORKSPACE>/Graph.java:java/util/ArrayList#size().
...
public class Graph {
    ...
    public void ajoutArete(int i, int j){
        ...
        if (sommets.si@@ze() < i || sommets.size() < j ||  sommets.size() < i && sommets.size() < j){
    ...
    public String toString(){
        if (sommets.isEmpty()) return "digraph{\n}";
        String dot = "digraph{\n";
